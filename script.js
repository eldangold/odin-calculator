...
window.addEventListener("keydown", function (event) {
    ...
    if (allowedNumbers.includes(event.key)) {
        if (calcData.firstNumber !== "" && calcData.secondNumber !== "" && event.key !== "=") {
            operate(calcData);
    ...
    if (allowedOperators.includes(event.key)) {
        ...
        else if (calcData.firstNumber && calcData.secondNumber && calcData.operator && (event.key == "="  || event.key == "Enter")) operate(calcData)
